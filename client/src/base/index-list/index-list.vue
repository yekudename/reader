<template>
  <div class="index-list">
    ...
    <div v-if="navbar" class="index-list-nav" @touchstart="onShortcutTouchStart" @touchmove.stop.prevent="onShortcutTouchMove">
    ...
    <div class="index-list-fixed index-list-anchor" ref="fixed" v-show="fixedTitle">
      {{ fixedTitle }}
    </div>
  </div>
</template>
...
import CubeScroll from 'base/scroll/scroll.vue'
...
export default {
  ...
  watch: {
    ...
    currentIndex(newVal) {
      this.$emit('current-index-changed', newVal)
    }
  },
  components: {
    CubeScroll,
