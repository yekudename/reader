...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DEV_DATABASE_URL') or \
        'mysql+pymysql://root:asdfghjkl123@localhost:3306/test?charset=utf8mb4'
...
# SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:asdfghjkl123@localhost:3306/test?charset=utf8mb4'
